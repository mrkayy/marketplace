class AppImageAssets {
  ...
  static String bg1 = "$_path/bg1.jpg";
  static String bg2 = "$_path/bg2.jpg";
  static String bg3 = "$_path/bg3.jpg";

  static String mens1 = "$_path/mens-1.jpeg";
  static String mens2 = "$_path/mens-2.jpeg";
